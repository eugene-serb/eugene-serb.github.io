...
![](https://img.shields.io/badge/VueUse-informational?style=flat-square&logo=vueuse&logoColor=FFFFFF&color=42B983)
...
- `npm run test:unit:coverage` — run unit tests coverage check
- `npm run test:e2e` — run e2e tests
- `npm run test:e2e:result` — run e2e tests results check
